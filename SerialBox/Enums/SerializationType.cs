...
namespace SerialBox.Enums
{
    ...
    public class SerializationType
    {
        ...
        public static SerializationType JSON => new("application/json");

        /// <summary>
        /// Gets the XML serialization type.
        /// </summary>
        /// <value>The XML serialization type.</value>
        public static SerializationType XML => new("text/xml");
        ...
        public static explicit operator SerializationType(string serializationType) => new(serializationType);
        ...
        /// <param name="serializationType">Type of the serialization.</param>
        /// <returns>The result of the conversion.</returns>
        public static implicit operator string(SerializationType serializationType) => serializationType.ToString();
